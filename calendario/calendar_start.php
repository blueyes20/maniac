...
echo'<div class="previous_month"><input name="myBtn" type="submit" value="Mes Anterior" onClick="javascript:last_month();"></div>';
echo'<div class="show_month">' .$showmonth .'/'.$showyear . '</div>';
echo'<div class="next_month"><input name="myBtn" type="submit" value="Mes Siguiente" onClick="javascript:next_month();"</div>';
echo'</div>';
...
for($i=1; $i<=$day_count; $i++){
	...
	if($num_rows > 0) {
		$event = "<input name='$date' type='submit' value='Detalles' id='$date' onClick='javascript:show_details(this);'>";
	}
	//end get events
